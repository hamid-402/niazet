...
export const ORDER_TRANSITIONS: Record<OrderStatus, OrderStatus[]> = {
  ...
  triaging: [OrderStatus.pending_quote, OrderStatus.quoted, OrderStatus.cancelled],
  ...
  in_progress: [OrderStatus.submitted_for_qc, OrderStatus.cancelled, OrderStatus.disputed],
  submitted_for_qc: [OrderStatus.qc_in_review],
  qc_in_review: [OrderStatus.qc_rejected, OrderStatus.ready_for_customer_review],
  qc_rejected: [OrderStatus.in_progress],
  ready_for_customer_review: [OrderStatus.delivered],
  delivered: [OrderStatus.confirmed, OrderStatus.revision_requested, OrderStatus.disputed],
...
export const FINAL_ORDER_STATUSES: OrderStatus[] = [OrderStatus.cancelled, OrderStatus.closed];
