...
نام‌های ثابت پیگیری: [هسته — محصول و پایداری — رفع ایراد/پذیرش](docs/ROADMAP.md) و [مدار — بازطراحی](docs/ORBIT_IMPLEMENTATION_ROADMAP.md). وضعیت جاری و موارد تعویقی در ابتدای این اسناد است؛ شمارهٔ مراحل بدون نام مسیر گزارش نشود.
