...
این gate مکمل قراردادهای استاتیک UI است و برنامه buildشده را با Chromium واقعی، API واقعی و PostgreSQL ایزوله بررسی می‌کند. ماتریس شامل ۱۸ مسیر مهمان و نقش‌دار، چهار عرض ۳۲۰، ۷۶۸، ۱۲۸۰ و ۱۹۲۰ و دو تم روشن و تیره است؛ در نتیجه هر اجرا ۱۴۴ وضعیت واقعی را می‌سنجد.
